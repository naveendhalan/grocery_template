...
class ProductDetailController extends GetxController {
  ...
  void _loadProduct(ProductEntity product) {
    ...
    discount.value = product.mrp != null && product.mrp! > product.price
    ...
    disclaimer.value =
        'Actual product packaging and materials may contain more and different information than what is shown here.';
    ...
    relatedProducts.assignAll(
      _productsMap.values.where((p) => p.id != product.id).take(3).toList(),
    );
  }
