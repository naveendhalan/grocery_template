...
class OrdersBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<OrdersController>(() => OrdersController(getOrdersUseCase: Get.find<GetOrdersUseCase>(), getOrderDetailUseCase: Get.find<GetOrderDetailUseCase>()), fenix: true);
  }
}
