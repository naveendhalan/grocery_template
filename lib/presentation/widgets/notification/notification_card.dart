  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: item.isRead ? theme.colorScheme.surface : theme.colorScheme.primaryContainer.withOpacity(0.2), borderRadius: BorderRadius.circular(16)),
        child: Row(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text("${item.time}", style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.onSurface.withOpacity(0.5))),
                ],
              ),
            ),
          ],
